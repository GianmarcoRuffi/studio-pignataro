    ...
    >
      ...
      <div className={`${styles["bio-box"]} lg:w-1/3 text-justify py-4`}>
        ...
        <p>
          ...
          tematiche di restauro e di recupero dell’edilizia storica e di
          progettazione architettonica nello studio del Prof. Arch. Giovanni
          Maria Campus. La pratica professionale svolta in 30 anni mi ha
          specializzato nel campo del restauro e recupero dell’edilizia storica
          grazie ai molteplici incarichi tra cui il recupero di sette edifici
          nel centro storico di Baunei (OG) per la Stams s.r.l. società del
          gruppo Cualbu. Nel campo della progettazione architettonica ho operato
          in Italia per clienti come Findomestic Banca, imprese di costruzione,
          cooperative e privati e grazie alla doppia cittadinanza italiana e
          statunitense, ho realizzato a Puerto Rico (U.S.A.) cinque negozi in
          centri commerciali ed una villa.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            normativa del Superbonus 110%, per il Coach Manager Regionale di
          ...
          <li>
            ...
            romani nel seminterrato del Palazzo storico Asquer, vincolato dalla
            Soprintendenza Ministeriale (SABAP) nel centro storico di Cagliari
            quartiere Castello
          </li>
          <li>
            Agenzia pubblicitaria Glisbo: Stand modulare per la “Regione
            Autonoma della Sardegna”{" "}
            <a href="https://glisbo.com/" target="_blank">
              www.glisbo.com
            </a>
          </li>
          <li>
          ...
          <li>
            ...
            del recupero di sette edifici nel centro storico di Baunei (OG){" "}
        ...
        <p>
          ...
          design di arredi; componente di un team composto da due architetti ed
          un ingegnere. Responsabile dei rapporti con committenza e imprese.
        </p>
        <ul>
          <li>
            Tangex Corp.: Progettazione di cinque negozi in centri commerciali a
            Puerto Rico (U.S.A.)
          </li>
          <li>
            Cooperativa edilizia Urbus: progettazione di un edificio
            residenziale a Cagliari
          </li>
          <li>
            Findomestic Banca: progettazione e d.l. delle “Sedi clienti/uffici
            territorio” a Cagliari e Sassari
          </li>
          <li>Discoteca Pandemonium: progettazione e d.l., Quartu S.E. (CA)</li>
          <li>
            Impresa Sarritzu: Progettazione di un Albergo Residence per 120
            studenti a Cagliari
          </li>
          <li>
        ...
        <h4>Progettista</h4>
        <p>
          Progettista unico o in partecipazione con altri architetti dalla fase
          ideativa sino alla realizzazione cantieristica dei seguenti progetti:
        </p>
        <ul>
