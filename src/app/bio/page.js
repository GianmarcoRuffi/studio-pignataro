    ...
    >
      ...
      <div className={`${styles["bio-box"]} lg:w-1/3 text-justify py-4`}>
        ...
        <p>
          ...
          progettazione architettonica. La pratica professionale svolta in 30
          anni mi ha specializzato nel campo del restauro e recupero
          dell’edilizia storica grazie ai molteplici incarichi tra cui il
          recupero di sette edifici nel centro storico di Baunei (OG) per la
          Stams s.r.l. società del gruppo Cualbu. Nel campo della progettazione
          architettonica ho operato in Italia per clienti come Findomestic
          Banca, imprese di costruzione, cooperative e privati e grazie alla
          doppia cittadinanza italiana e statunitense, ho realizzato a Puerto
          Rico (U.S.A.) cinque negozi in centri commerciali ed una villa.
        </p>
