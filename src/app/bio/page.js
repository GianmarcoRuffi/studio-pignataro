    ...
    <div className="bio-container flex bg-gray-100 max-lg:flex-col">
        ...
        <div className="bio-box lg:w-1/2 text-justify">
          ...
          <p>
            ...
            Stams s.r.l. società del gruppo Cualbu. Nel campo della
          ...
          <ul>
            ...
            <li>
              Casa Reinhold-Porcu: Ristrutturazione con Interior design nel
              centro storico di Cagliari
            </li>
            <li>
              Palazzo Asquer: Messa in sicurezza strutturale con restauro di
              resti romani nel seminterrato del Palazzo storico Asquer,
              vincolato dalla Soprintendenza Ministeriale (SABAP) nel centro
              storico di Cagliari quartiere Castello
            </li>
            <li>
            ...
            <li>
              Perito estimatore per la “Banca di Credito Cooperativo di
              Cagliari”
            </li>
            <li>
            ...
            <li>
              Casa Piras: Ristrutturazione con Interior design nel centro
              storico di Cagliari, quartiere Villanova (lavoro pubblicato)
            </li>
            <li>
          ...
          <ul>
            <li>
              Tangex Corp.: Progettazione di cinque negozi in centri commerciali
              a Puerto Rico (U.S.A.)
            </li>
            <li>
            ...
            <li>
              Edificio Commendatore: Progettazione, Interior design e d.l. di
              una palazzina residenziale a Cagliari
            </li>
            <li>
              Casa Cugusi: ristrutturazione di un appartamento nel centro
